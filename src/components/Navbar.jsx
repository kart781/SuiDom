...
function Navbar() {
    ...
    return (
        <div className="navbar fixed top-0 left-0 right-0 z-50" style={{ backgroundColor: "rgb(33, 93, 180)", padding: "1rem 0" }}>
            <div className="flex items-center gap-4 px-4 justify-between w-full">
                {/* Logo Section */}
                <div className="flex items-center gap-4">
                    <img src={logoImage} alt="Logo" className="h-12 w-12 rounded-full" />
                ...
                <div className="hidden lg:flex gap-3 ml-auto">
                    ...
                    <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="btn btn-circle bg-gradient-to-r from-pink-500 to-purple-500 text-white text-xl border-none" aria-label="Instagram">
                    ...
                    <a href="https://telegram.org" target="_blank" rel="noopener noreferrer" className="btn btn-circle bg-blue-500 text-white text-xl border-none" aria-label="Telegram">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-6 w-6 fill-current">
                    ...
                    <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="btn btn-circle bg-black text-white text-xl border-none" aria-label="X">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-6 w-6 fill-current">
            ...
            {isMobileMenuOpen && (
                <div className="lg:hidden bg-blue-700 text-white w-full flex flex-col items-center py-4 space-y-4 transition-all duration-300">
                    <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-lg font-semibold">Instagram</a>
                    <a href="https://telegram.org" target="_blank" rel="noopener noreferrer" className="text-lg font-semibold">Telegram</a>
                    <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-lg font-semibold">Twitter</a>
                </div>
            )}
        </div>
    );
